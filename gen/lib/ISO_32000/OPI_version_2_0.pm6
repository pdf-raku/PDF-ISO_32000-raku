use v6;
#  -- DO NOT EDIT --
# generated by: ../../bin/make-modules.p6 --role-name=ISO_32000::OPI_version_2_0 ../tables/OPI_version_2_0_entries.html
...
role ISO_32000::OPI_version_2_0 {
    ...
    method F {...};	#| [file specification] %%ImageFilename
	#| (Required) The external file containing the low- resolution proxy image.
    method MainImage {...};	#| [byte string] %%MainImage
    ...
    method Tags {...};	#| [array] %%TIFFASCIITag
    ...
    method Overprint {...};	#| [boolean] %%ImageOverprint
    ...
    method Inks {...};	#| [name or array] %%ImageInks
    ...
    method IncludedImageDimensions {...};	#| [Span] Span 
    method IncludedImageQuality {...};	#| [Span] Span 
}
