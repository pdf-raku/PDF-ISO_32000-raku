use v6;
# generated by: ../../etc/make-modules.p6 --role-name=ISO_32000::Artifact ../tables/Artifact_entries.html
...
=head2 Subtype [name]
- (Optional; PDF 1.7) The subtype of the artifact. This entry should appear only when the Type entry has a value of Pagination. Standard values are Header, Footer, and Watermark. Additional values may be specified for this entry, provided they comply with the naming conventions described in Link Annex E .
