use v6;
# generated by: ../../etc/make-modules.p6 --role-name=ISO_32000::Minimum_bit_depth ../tables/Minimum_bit_depth_entries.html
...
=head2 M [integer]
- (Optional) A monitor specifier (see Link Ta b l e 270 ) that specifies which monitor the value of V should be tested against. If the value is unrecognized, the object shall not be viable.
Default value: 0.
