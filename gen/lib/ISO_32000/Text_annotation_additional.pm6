use v6;
# generated by: ../../etc/make-modules.p6 --role-name=ISO_32000::Text_annotation_additional ../tables/Text_annotation_additional_entries.html
...
- (Optional; PDF 1.5) The state to which the original annotation is set; see Link 12.5.6.3, “Annotation States.”
Default: “Unmarked” if StateModel is “Marked”; “None” if StateModel is “Review”.

=head2 StateModel [text string]
- (Required if State is present, otherwise optional; PDF 1.5) The state model corresponding to State; see Link 12.5.6.3, “Annotation States.” Span 
