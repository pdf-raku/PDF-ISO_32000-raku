use v6;
# generated by: ../../etc/make-modules.p6 --role-name=ISO_32000::Alternate_Image ../tables/Alternate_Image_entries.html
...
=head2 OC [dictionary]
- (Optional; PDF 1.5) An optional content group (see Link 8.11.2, "Optional Content Groups" ) or optional content membership dictionary (see Link 8.11.2.2, "Optional Content Membership Dictionaries" ) that facilitates the selection of which alternate image to use.
