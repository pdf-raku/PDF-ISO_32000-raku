...
- (Optional) A certificate seed value dictionary (see Link Table 235 ) containing information about the characteristics of the certificate that is used when signing.
...
- (Optional; PDF 1.6) An array of text strings specifying possible legal attestations (see Link 12.8.5, “Legal Content Attestations” ). The value of the corresponding flag in the Ff entry indicates whether this is a required constraint.
