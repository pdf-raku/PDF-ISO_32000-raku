use v6;
# generated by: ../../etc/make-modules.p6 --role-name=ISO_32000::Launch_action_additional ../tables/Launch_action_additional_entries.html
...
- (Optional) A dictionary containing Windows-specific launch parameters (see Link Table 204 ).
