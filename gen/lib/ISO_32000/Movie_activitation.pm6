...
role ISO_32000::Movie_activitation {
    ...
    method Duration {...};	#| [(various)] (Optional) The duration of the movie segment to be played, that is specified in the same form as Start. If this entry is omitted, the movie is played to the end.
    method Rate {...};	#| [number] (Optional) The initial speed at which to play the movie. If the value of this entry is negative, the movie is played backward with respect to Start and Duration. Default value: 1.0.
    ...
    method FWScale {...};	#| [array] (Optional) The magnification (zoom) factor at which the movie is played. The presence of this entry implies that the movie is played in a floating window. If the entry is absent, the movie is played in the annotation rectangle.
    ...
    method FWPosition {...};	#| [array] (Optional) For floating play windows, the relative position of the window on the screen. The value is an array of two numbers
	#| [ horiz vert ]
