...
=head2 M [integer]
- (Optional) A monitor specifier that specifies which monitor the value of V should be tested against. If the value is unrecognized, the object is not viable.
Default value: 0.
