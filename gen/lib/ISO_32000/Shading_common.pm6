use v6;
# generated by: ../../etc/make-modules.p6 --role-name=ISO_32000::Shading_common ../tables/Shading_common_entries.html
...
- (Required) The colour space in which colour values shall beexpressed. This may be any device, CIE-based, or special colour space except a Pattern space. See Link 8.7.4.4, "Colour Space: Special Considerations" for further information.
