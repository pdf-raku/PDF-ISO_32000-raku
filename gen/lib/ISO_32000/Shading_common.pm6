...
role ISO_32000::Shading_common {
    method ShadingType {...};	#| [integer] (Required) The shading type:
    ...
    method ColorSpace {...};	#| [name or array] (Required) The colour space in which colour values shall beexpressed. This may be any device, CIE-based, or special colour space except a Pattern space. See Link 8.7.4.4, "Colour Space: Special Considerations" for further information.
    method Background {...};	#| [array] (Optional) An array of colour components appropriate to the colour space, specifying a single background colour value. If present, this colour is used, before any painting operation involving the shading, to fill those portions of the area to be painted that lie outside the bounds of the shading object.
    ...
    method BBox {...};	#| [rectangle] (Optional) An array of four numbers giving the left, bottom, right, and top coordinates, respectively, of the shading’s bounding box. The coordinates is interpreted in the shading’s target coordinate space. If present, this bounding box is applied as a temporary clipping boundary when the shading is painted, in addition to the current clipping path and any other clipping boundaries in effect at that time.
    method AntiAlias {...};	#| [boolean] (Optional) A flag indicating whether to filter the shading function to prevent aliasing artifacts.
