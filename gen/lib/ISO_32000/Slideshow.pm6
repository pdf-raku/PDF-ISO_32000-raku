...
role ISO_32000::Slideshow {
    method Type {...};	#| [name] (Required; PDF 1.4) The type of PDF object that this dictionary describes; shall be SlideShow for a slideshow dictionary.
    method Subtype {...};	#| [name] (Required; PDF 1.4) The subtype of the PDF object that this dictionary describes; shall be Embedded for a slideshow dictionary.
