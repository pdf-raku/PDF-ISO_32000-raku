...
- (Required) An array of three numbers [ X W Y W Z W ] that shall specify the tristimulus value, in the CIE 1931 XYZ space, of the diffuse white point. The numbers X W and Z W is positive, and Y W is 1.0.

=head2 BlackPoint [array]
- (Optional) An array of three numbers [ X B Y B Z B ] that shall specify the tristimulus value, in the CIE 1931 XYZ space, of the diffuse black point. All three of these numbers is non-negative. Default value: [ 0.0 0.0 0.0 ].
