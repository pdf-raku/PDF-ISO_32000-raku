use v6;
# generated by: ../../etc/make-modules.p6 --role-name=ISO_32000::Font_descriptor_common ../tables/Font_descriptor_common_entries.html
...
- (Optional) A stream containing a Type 1 font program (see Link 9.9, "Embedded Font Programs" ).

=head2 FontFile2 [stream]
- (Optional; PDF 1.1) A stream containing a TrueType font program (see Link 9.9, "Embedded Font Programs" ).

=head2 FontFile3 [stream]
- (Optional; PDF 1.2) A stream containing a font program whose format is specified by the Subtype entry in the stream dictionary (see Link Table 126 ).
