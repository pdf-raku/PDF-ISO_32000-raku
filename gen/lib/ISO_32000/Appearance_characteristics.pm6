use v6;
# generated by: ../../etc/make-modules.p6 --role-name=ISO_32000::Appearance_characteristics ../tables/Appearance_characteristics_entries.html
...
=head2 IF [dictionary]
- (Optional; pushbutton fields only) An icon fit dictionary (see Link Table 247 ) specifying how the widget annotation’s icon is displayed within its annotation rectangle. If present, the icon fit dictionary shall apply to all of the annotation’s icons (normal, rollover, and alternate).
