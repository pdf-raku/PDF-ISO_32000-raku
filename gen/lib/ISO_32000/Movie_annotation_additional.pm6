...
role ISO_32000::Movie_annotation_additional {
    method Subtype {...};	#| [name] (Required) The type of annotation that this dictionary describes; is Movie for a movie annotation.
    ...
    method A {...};	#| [boolean or dictionary] (Optional) A flag or dictionary specifying whether and how to play the movie when the annotation is activated. If this value is a dictionary, it is a movie activation dictionary (see Link 13.4, “Movies” ) specifying how to play the movie. If the value is the boolean true, the movie is played using default activation parameters. If the value is false, the movie shall not be played. Default value: true.
}
