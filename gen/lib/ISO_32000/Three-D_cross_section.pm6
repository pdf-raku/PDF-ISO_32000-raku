...
role ISO_32000::Three-D_cross_section {
    method Type {...};	#| [name] (Optional) The type of PDF object that this dictionary describes; if present, is 3DCrossSection for a 3D cross section dictionary.
    ...
    method IV {...};	#| [boolean] (Optional) A flag indicating the visibility of the intersection of the cutting plane with any 3D geometry. If true, then the intersection is visible. If false, then the intersection shall not be visible.
	#| Default value: false
