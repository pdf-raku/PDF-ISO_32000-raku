...
- (Required) A software identifier dictionary (see Link 13.2.7.4, “Software Identifier Dictionary” ) that shall specify the player name, versions, and operating systems to which this media player info dictionary applies.
