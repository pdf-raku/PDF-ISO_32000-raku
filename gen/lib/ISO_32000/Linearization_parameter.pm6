use v6;
# generated by: ../../etc/make-modules.p6 --role-name=ISO_32000::Linearization_parameter ../tables/Linearization_parameter_entries.html
...
=head2 P [integer]
- (Optional) The page number of the first page; see Link F.3.4, "First-Page Cross-Reference Table and Trailer (Part 3)" . Default value: 0.
