use v6;
#  -- DO NOT EDIT --
# generated by: ../../bin/make-modules.p6 --role-name=ISO_32000::Border_style ../tables/Border_style_entries.html

role ISO_32000::Border_style {
    method Type {...};	#| [name] (Optional) The type of PDF object that this dictionary describes; if present, shall be Border for a border style dictionary.
    method W {...};	#| [number] (Optional) The border width in points. If this value is 0, no border shall drawn. Default value: 1.
    method S {...};	#| [name] (Optional) The border style:
    ...
    method D {...};	#| [array] (Optional) A dash array defining a pattern of dashes and gaps that shall beused in drawing a dashed border (border style D in the S entry). The dash array shall be specified in the same format as in the line dash pattern parameter of the graphics state (see Link 8.4.3.6, “Line Dash Pattern” ). The dash phase is not specified and shall be assumed to be 0.
