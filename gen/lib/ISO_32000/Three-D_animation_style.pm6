...
=head2 Subtype [name]
- (Optional) The animation style described by this dictionary; see Link Table 302 for valid values. If an animation style is encountered other than those described in Link Ta b l e 302 , an animation style of None is used.
Default value: None
