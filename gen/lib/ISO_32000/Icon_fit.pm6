...
role ISO_32000::Icon_fit {
    method SW {...};	#| [name] (Optional) The circumstances under which the icon is scaled inside the annotation rectangle:
	#| A Always scale.
	...
	#| N Never scale.
	#| Default value: A.
    method S {...};	#| [name] (Optional) The type of scaling that is used:
	...
	#| Default value: P.
    method A {...};	#| [array] (Optional) An array of two numbers that is between 0.0 and 1.0 indicating the fraction of leftover space to allocate at the left and bottom of the icon. A value of [ 0.0 0.0 ] shall position the icon at the bottom-left corner of the annotation rectangle. A value of [ 0.5 0.5 ] shall center it within the rectangle. This entry is used only if the icon is scaled proportionally. Default value: [ 0.5 0.5 ].
    method FB {...};	#| [boolean] (Optional; PDF 1.5) If true, indicates that the button appearance is scaled to fit fully within the bounds of the annotation without taking into consideration the line width of the border. Default value: false.
}
