...
role ISO_32000::Media_play_parameters {
    method Type {...};	#| [name] (Optional) The type of PDF object that this dictionary describes; if present, shall be MediaPlayParams for a media play parameters dictionary.
    ...
    method MH {...};	#| [dictionary] (Optional) A dictionary whose entries (see Link Ta b l e 278 ) shall be honoured for the media play parameters to be considered viable.
