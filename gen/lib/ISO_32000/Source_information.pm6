use v6;
# generated by: ../../etc/make-modules.p6 --role-name=ISO_32000::Source_information ../../resources/ISO_32000/Source_information_entries.json
...
- (Required) An ASCII string or URL alias dictionary which shall identify the URLs from which the source data was retrieved.
...
=head2 S [integer]
- (Optional) A code which, if present, shall indicate the type of form submission, if any, by which the source data was accessed. If present, the value of the S entry is 0, 1, or 2, in accordance with the following meanings:
...
=head2 C [dictionary]
- (Optional; if present, is an indirect reference) A command dictionary describing the command that caused the source data to be retrieved. This entry may be present only in source information dictionaries associated with page sets.
