use v6;
# generated by: ../../etc/make-modules.p6 --role-name=ISO_32000::JavaScript ../tables/JavaScript_entries.html
...
- (Optional; PDF 1.6) A text string or text stream containing a JavaScript script that is executed after the FDF file is imported and the usage rights in the PDF document have been determined (see Link 12.8.2.3, “UR” ).
