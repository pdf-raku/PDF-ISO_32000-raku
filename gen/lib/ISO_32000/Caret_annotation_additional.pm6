...
role ISO_32000::Caret_annotation_additional {
    method Subtype {...};	#| [name] (Required) The type of annotation that this dictionary describes; is Caret for a caret annotation.
    ...
    method Sy {...};	#| [name] (Optional) A name specifying a symbol that is associated with the caret:
