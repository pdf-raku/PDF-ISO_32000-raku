...
• As the blending colour space in which objects is composited within the group
...
=head2 I [boolean]
- (Optional) A flag specifying whether the transparency group is isolated. If this flag is true, objects within the group is composited against a fully transparent initial backdrop; if false, they is composited against the group’s backdrop. Default value: false.
...
=head2 K [boolean]
- (Optional) A flag specifying whether the transparency group is a knockout group. If this flag is false, later objects within the group is composited with earlier ones with which they overlap; if true, they is composited with the group’s initial backdrop and shall overwrite (“knock out”) any earlier overlapping objects. Default value: false.
