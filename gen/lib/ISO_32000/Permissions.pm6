use v6;
# generated by: ../../etc/make-modules.p6 --role-name=ISO_32000::Permissions ../tables/Permissions_entries.html
...
- (Optional) An indirect reference to a signature dictionary (see Link Ta b l e 252 ). This dictionary shall contain a Reference entry that is a signature reference dictionary (see Link Table 252 ) that has a DocMDP transform method (see Link 12.8.2.2, “DocMDP” ) and corresponding transform parameters.
