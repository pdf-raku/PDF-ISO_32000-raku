use v6;
# generated by: ../../etc/make-modules.p6 --role-name=ISO_32000::Rendition_action_additional ../tables/Rendition_action_additional_entries.html
...
=head2 R [dictionary]
- (Required when OP is present with a value of 0 or 4; otherwise optional) A rendition object (see Link 13.2.3, “Renditions” ).

=head2 AN [dictionary]
- (Required if OP is present with a value of 0, 1, 2, 3 or 4; otherwise optional) An indirect reference to a screen annotation (see Link 12.5.6.18, “Screen Annotations” ).
