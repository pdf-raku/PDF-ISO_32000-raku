...
role ISO_32000::Collection_field {
    method Type {...};	#| [name] (Optional) The type of PDF object that this dictionary describes; if present, is CollectionField for a collection field dictionary.
    method Subtype {...};	#| [name] (Required) The subtype of collection field or file-related field that this dictionary describes. This entry identifies the type of data that is stored in the field.
    ...
    method N {...};	#| [text string] (Required) The textual field name that is presented to the user by the conforming reader.
    method O {...};	#| [integer] (Optional) The relative order of the field name in the user interface. Fields is sorted by the conforming reader in ascending order.
