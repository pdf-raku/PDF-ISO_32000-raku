use v6;
# generated by: ../../etc/make-modules.p6 --role-name=ISO_32000::Mimimum_screen_size ../tables/Mimimum_screen_size_entries.html
...
=head2 M [integer]
- (Optional) A monitor specifier (see Link Ta b l e 293 ) that specifies which monitor the value of V should be tested against. If the value is unrecognized, the object is not viable.
Default value: 0.
