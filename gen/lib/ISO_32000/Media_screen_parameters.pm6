...
=head2 MH [dictionary]
- (Optional) A dictionary whose entries is honoured for the media screen parameters to be considered viable.

=head2 BE [dictionary]
- (Optional) A dictionary whose entries should be honoured.
