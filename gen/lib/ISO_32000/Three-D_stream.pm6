use v6;
# generated by: ../../etc/make-modules.p6 --role-name=ISO_32000::Three-D_stream ../tables/Three-D_stream_entries.html
...
=head2 AN [dictionary]
- (Optional; PDF 1.7) An animation style dictionary indicating the method that conforming readers should use to drive keyframe animations present in this artwork (see Link 13.6.3.2, "3D Animation Style Dictionaries" ).
