...
role ISO_32000::DocMDP_transform {
    ...
    method P {...};	#| [number] (Optional) The access permissions granted for this document. Valid values is:
	...
	#| Default value: 2.
    method V {...};	#| [name] (Optional) The DocMDP transform parameters dictionary version. The only valid value is 1.2.
