use v6;
# generated by: ../../etc/make-modules.p6 --role-name=ISO_32000::Marked_content_reference ../tables/Marked_content_reference_entries.html
...
=head2 Stm [stream]
- (Optional; is an indirect reference) The content stream containing the marked-content sequence. This entry should be present only if the marked-content sequence resides in a content stream other than the content stream for the page (see Link 8.10, “Form XObjects” and Link 12.5.5, “Appearance Streams” ).
