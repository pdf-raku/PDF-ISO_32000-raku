...
- (Optional) The data corresponding to the related entry in the collection field dictionary (see Ta ble 157). The type of data matches the data type identified by the corresponding collection field dictionary. Default: none.
