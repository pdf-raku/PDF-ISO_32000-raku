...
role ISO_32000::Target {
    ...
    method N {...};	#| [byte string] (Required if the value of R is C and the target is located in the EmbeddedFiles name tree; otherwise, it is absent) The name of the file in the EmbeddedFiles name tree.
