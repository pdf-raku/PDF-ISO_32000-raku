...
The filter distinguish among negative, zero, and positive values of K to determine how to interpret the encoded data; however, it does not distinguish between different positive Kvalues. Default value: 0.

=head2 EndOfLine [boolean]
- A flag indicating whether end-of-line bit patterns is present in the encoding. The CCITTFaxDecode filter always accept end-of-line bit patterns. If EndOfLine is trueend-of-line bit patterns is present.Default value: false.
