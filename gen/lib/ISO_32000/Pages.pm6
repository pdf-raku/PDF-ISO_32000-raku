...
role ISO_32000::Pages {
    method Type {...};	#| [name] (Required) The type of PDF object that this dictionary describes; is Pages for a page tree node.
    method Parent {...};	#| [dictionary] (Required except in root node; prohibited in the root node; is an indirect reference) The page tree node that is the immediate parent of this one.
