use v6;
# generated by: ../../bin/make-modules.p6 --role-name=ISO_32000::Field_common ../tables/Field_common_entries.html
...
=head2 T [text string]
- (Optional) The partial field name (see Link 12.7.3.2, “Field Names” ).
...
=head2 Ff [integer]
- (Optional; inheritable) A set of flags specifying various characteristics of the field (see Link Table 221 ). Default value: 0.

=head2 V [(various)]
- (Optional; inheritable) The field’s value, whose format varies depending on the field type. See the descriptions of individual field types for further information.

=head2 DV [(various)]
- (Optional; inheritable) The default value to which the field reverts when a reset-form action is executed (see Link 12.7.5.3, “Reset-Form Action” ). The format of this value is the same as that of V.

=head2 AA [dictionary]
- (Optional; PDF 1.2) An additional-actions dictionary defining the field’s behaviour in response to various trigger events (see Link 12.6.3, “Trigger Events” ). This entry has exactly the same meaning as the AA entry in an annotation dictionary (see Link 12.5.2, “Annotation Dictionaries” ).
