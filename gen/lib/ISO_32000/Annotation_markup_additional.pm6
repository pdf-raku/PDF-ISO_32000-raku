use v6;
# generated by: ../../etc/make-modules.p6 --role-name=ISO_32000::Annotation_markup_additional ../tables/Annotation_markup_additional_entries.html
...
- (Optional; PDF 1.5) A rich text string (see Link 12.7.3.4, “Rich Text Strings” ) that is displayed in the pop-up window when the annotation is opened.

=head2 CreationDate [date]
- (Optional; PDF 1.5) The date and time ( Link 7.9.4, “Dates” ) when the annotation was created.
