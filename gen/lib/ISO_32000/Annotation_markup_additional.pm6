...
role ISO_32000::Annotation_markup_additional {
    method T {...};	#| [text string] (Optional; PDF 1.1) The text label that is displayed in the title bar of the annotation’s pop-up window when open and active. This entry shall identify the user who added the annotation.
    ...
    method RC {...};	#| [text string or text stream] (Optional; PDF 1.5) A rich text string (see Link 12.7.3.4, “Rich Text Strings” ) that is displayed in the pop-up window when the annotation is opened.
    method CreationDate {...};	#| [date] (Optional; PDF 1.5) The date and time ( Link 7.9.4, “Dates” ) when the annotation was created.
    method IRT {...};	#| [dictionary] (Required if an RT entry is present, otherwise optional; PDF 1.5) A reference to the annotation that this annotation is “in reply to.” Both annotations is on the same page of the document. The relationship between the two annotations is specified by the RT entry.
    ...
    method ExData {...};	#| [dictionary] (Optional; PDF 1.7) An external data dictionary specifying data that is associated with the annotation. This dictionary contains the following entries:
	#| Type (optional) If present, is ExData.
	#| Subtype (required) a name specifying the type of data that the markup annotation is associated with. The only defined value is Markup3D. Link Ta b l e 298 lists the values that correspond to a subtype of Markup3D.
}
