use v6;
# generated by: ../../etc/make-modules.p6 --role-name=ISO_32000::Type_6_Shading ../tables/Type_6_Shading_entries.html
...
=head2 Decode [array]
- (Required) An array of numbers specifying how to map coordinates and colour components into the appropriate ranges of values. The decoding method is similar to that used in image dictionaries (see Link 8.9.5.2, "Decode Arrays" ). The ranges is specified as follows:
