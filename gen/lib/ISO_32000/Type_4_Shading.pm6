...
- (Required) The number of bits used to represent the edge flag for each vertex. The value of BitsPerFlag is 2, 4, or8, but only the least significant 2 bits in each flag value shall beused. The value for the edge flag is 0, 1, or 2.
