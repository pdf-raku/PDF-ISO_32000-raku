...
=head2 DA [string]
- (Required) The default appearance string that is used in formatting the text.
...
- (Optional; PDF 1.5) A rich text string that is used to generate the appearance of the annotation.
...
=head2 IT [name]
- (Optional; PDF 1.6) A name describing the intent of the free text annotation. The following values is valid:
...
=head2 BE [dictionary]
- (Optional; PDF 1.6) A border effect dictionary used in conjunction with the border style dictionary specified by the BS entry.
...
=head2 BS [dictionary]
- (Optional; PDF 1.6) A border style dictionary specifying the line width and dash pattern that is used in drawing the annotation’s border.
