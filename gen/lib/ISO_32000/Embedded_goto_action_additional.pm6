use v6;
# generated by: ../../etc/make-modules.p6 --role-name=ISO_32000::Embedded_goto_action_additional ../tables/Embedded_goto_action_additional_entries.html
...
- (Required) The destination in the target to jump to (see Link 12.3.2, “Destinations” ).
...
=head2 T [dictionary]
- (Optional if F is present; otherwise required) A target dictionary (see Link Ta b l e 202 ) specifying path information to the target document. Each target dictionary specifies one element in the full path to the target and may have nested target dictionaries specifying additional elements.
