use v6;
#  -- DO NOT EDIT --
# generated by: ../../bin/make-modules.p6 --role-name=ISO_32000::Optional_Content_Configuration ../tables/Optional_Content_Configuration_entries.html
...
role ISO_32000::Optional_Content_Configuration {
    ...
    method BaseState {...};	#| [name] (Optional) Used to initialize the states of all the optional content groups in a document when this configuration is applied. The value of this entry is one of the following names:
    ...
    method Intent {...};	#| [name or array] (Optional) A single intent name or an array containing any combination of names. it is used to determine which optional content groups’ states to consider and which to ignore in calculating the visibility of content (see Link 8.11.2.3, "Intent" ).
    ...
    method AS {...};	#| [array] (Optional) An array of usage application dictionaries (see Link Ta b l e 103 ) specifying which usage dictionary categories (see Link Table 102 ) is consulted by conforming readers to automatically set the states of optional content groups based on external factors, such as the current system language or viewing magnification, and when they shall beapplied.
    ...
    method ListMode {...};	#| [name] (Optional) A name specifying which optional content groups in the Order array is displayed to the user. Valid values is:
