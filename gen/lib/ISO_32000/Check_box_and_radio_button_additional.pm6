...
role ISO_32000::Check_box_and_radio_button_additional {
    method Opt {...};	#| [array of text strings] (Optional; inheritable; PDF 1.4) An array containing one entry for each widget annotation in the Kids array of the radio button or check box field. Each entry is a text string representing the on state of the corresponding widget annotation.
