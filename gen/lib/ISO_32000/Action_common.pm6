use v6;
# generated by: ../../etc/make-modules.p6 --role-name=ISO_32000::Action_common ../tables/Action_common_entries.html
...
=head2 S [name]
- (Required) The type of action that this dictionary describes; see Link Ta b l e 194 for specific values.
