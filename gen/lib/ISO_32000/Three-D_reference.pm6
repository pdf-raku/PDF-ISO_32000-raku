use v6;
# generated by: ../../etc/make-modules.p6 --role-name=ISO_32000::Three-D_reference ../tables/Three-D_reference_entries.html
...
=head2 3DD [stream]
- (Required) The 3D stream (see Link 13.6.3, “3D Streams” ) containing the specification of the 3D artwork.
