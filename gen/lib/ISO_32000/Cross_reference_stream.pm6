...
role ISO_32000::Cross_reference_stream {
    method Type {...};	#| [name] (Required) The type of PDF object that this dictionary describes; is XRef for a cross-reference stream.
    method Size {...};	#| [integer] (Required) The number one greater than the highest object number used in this section or in any section for which this is an update. It is equivalent to the Size entry in a trailer dictionary.
    method Index {...};	#| [array] (Optional) An array containing a pair of integers for each subsection in this section. The first integer is the first object number in the subsection; the second integer is the number of entries in the subsection
