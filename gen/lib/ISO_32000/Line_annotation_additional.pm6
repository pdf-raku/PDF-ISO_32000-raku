...
=head2 IC [array]
- (Optional; PDF 1.4) An array of numbers in the range 0.0 to 1.0 specifying the interior color that is used to fill the annotation’s line endings. The number of array elements shall determine the colour space in which the colour is defined:
...
=head2 IT [name]
- (Optional; PDF 1.6) A name describing the intent of the line annotation. Valid values is LineArrow, which means that the annotation is intended to function as an arrow, and LineDimension, which means that the annotation is intended to function as a dimension line.
...
- (Optional; PDF 1.7) A measure dictionary that shall specify the scale and units that apply to the line annotation.
