...
role ISO_32000::Embedded_file_parameter {
    ...
    method CheckSum {...};	#| [string] (Optional) A 16-byte string that is the checksum of the bytes of the uncompressed embedded file. The checksum is calculated by applying the standard MD5 message-digest algorithm (described in Internet RFC 1321, The MD5 Message-Digest Algorithm; see the Link Bibliography ) to the bytes of the embedded file stream.
}
