...
=head2 BS [dictionary]
- (Optional) A border style dictionary (see Link Ta b l e 166 ) specifying the line width and dash pattern that is used in drawing the rectangle or ellipse.
...
=head2 BE [dictionary]
- (Optional; PDF 1.5) A border effect dictionary describing an effect applied to the border described by the BS entry (see Link Ta b l e 167 ).
