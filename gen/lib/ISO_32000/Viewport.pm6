use v6;
# generated by: ../../etc/make-modules.p6 --role-name=ISO_32000::Viewport ../tables/Viewport_entries.html
...
- (Optional) A measure dictionary (see Link Table 261 ) that specifies the scale and units that shall apply to measurements taken on the contents within the viewport.
