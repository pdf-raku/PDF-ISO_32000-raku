...
role ISO_32000::Type_5_Shading {
    ...
    method VerticesPerRow {...};	#| [integer] (Required) The number of vertices in each row of the lattice; the value is greater than or equal to 2. The number of rows need not be specified.
