use v6;
# generated by: ../../etc/make-modules.p6 --role-name=ISO_32000::Web_capture_command ../tables/Web_capture_command_entries.html
...
=head2 F [integer]
- (Optional) A set of flags specifying various characteristics of the command (see Link Ta b l e 357 ). Defaut value: 0.
...
=head2 S [dictionary]
- (Optional) A command settings dictionary containing settings used in the conversion process (see Link 14.10.5.4, “Command Settings” ).
